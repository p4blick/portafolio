                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Rut::</label>
                            <input type="text" class="form-control" name="rut" id="rut" oninput="checkRut(this)" required maxlength="10" placeholder="11111111-1" required>
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Area(*):</label>
                            <select id="idArea" name="idArea" class="form-control selectpicker" data-live-search="true"  required>Selecciona una opción</select>
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select id="idUsuario2" name="idUsuario2" class="form-control selectpicker" data-live-search="true" required></select>
                          </div>
